...
class BodyBuildingChatPage extends StatefulWidget {
  const BodyBuildingChatPage({Key? key}) : super(key: key);

  @override
  State<BodyBuildingChatPage> createState() => _BodyBuildingChatPageState();
}

class _BodyBuildingChatPageState extends State<BodyBuildingChatPage> {
